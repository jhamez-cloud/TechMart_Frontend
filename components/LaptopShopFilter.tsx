  ...
  return (
    <div className="grid items-stretch grid-cols-[300px_1fr] gap-4 min-h-screen mt-4">
      ...
      <aside className="row-start-1 col-start-1 bg-white rounded-2xl p-6 shadow-sm">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm text-gray-600 pl-2">
            ...
            <li className="hover:text-black cursor-pointer">HP</li>
            <li className="font-semibold text-black cursor-pointer">Dell</li>
            <li className="hover:text-black cursor-pointer">Lenovo</li>
            <li className="hover:text-black cursor-pointer">MacBook</li>
            <li className="hover:text-black cursor-pointer">ASUS</li>
            <li className="hover:text-black cursor-pointer">MSI</li>
            <li className="hover:text-black cursor-pointer">Microsoft Surface</li>
            <li className="hover:text-black cursor-pointer">Acer</li>
            <li className="hover:text-black cursor-pointer">Computer Accessories</li>
            <li className="hover:text-black cursor-pointer">Gaming PCs</li>
          ...
          <div className="flex items-center justify-between">
            ...
            <ShopList>
              <ProductCard
                ...
                in_stock
                stock_left={152}
                image='/images/laptops/surface_laptop_go3.jpg'
              />
      ...
      <aside className="row-start-2 col-start-1 bg-white rounded-2xl p-6 shadow-sm space-y-8">
        ...
        <div className='w-full flex-1 rounded-md bg-[url("/images/hero-camera.png")] bg-cover'>
      ...
      <section className="row-start-2 col-start-2 flex flex-col bg-white rounded-2xl p-6 min-h-510">
