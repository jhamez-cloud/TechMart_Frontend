  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-4 min-h-screen mt-4">
      ...
      <div className={`
        ...
        transform ${showFilters ? 'translate-x-0 shadow-black shadow-2xl' : '-translate-x-full'}
      ...
      `}>
        ...
        <aside className="bg-white rounded-2xl p-6 space-y-8">

          {/* Categories header */}
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-bold">CATEGORIES</h2>
            <button className="text-xs text-gray-400 hover:text-black">Reset All</button>
          </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <main className="bg-white rounded-2xl p-6">
          <h1 className="text-lg font-bold mb-4">BEST SELLER IN THIS CATEGORY</h1>
        ...
        {/* PRODUCTS */}
        <section className="bg-white rounded-2xl p-6 flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between gap-4 border-b pb-4">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="relative">
                  <button onClick={() => setOpenView(!openView)} className="text-sm text-gray-600 cursor-pointer">
                    View As
                  </button>
                  <ul className={`absolute right-0 top-full mt-2 z-20 bg-white border border-gray-200 rounded-md shadow-md w-28 ${openView ? "block" : "hidden"}`}>
                    <li className="flex items-center gap-2 px-3 py-2 hover:bg-gray-100 cursor-pointer text-sm"><Grid2X2 size={16}/> Grid</li>
                    <li className="flex items-center gap-2 px-3 py-2 hover:bg-gray-100 cursor-pointer text-sm"><List size={16}/> List</li>
                  </ul>
                </div>
          ...
          <ShopList>
            {paginatedProducts.map(product => (
              <ProductCard
                key={product.id}
                id={product.variants?.[0]?.id} // variant id
          ...
          <Pagination className="mt-6">
            <PaginationContent>
              ...
              {Array.from({length:totalPages},(_,i)=>(<PaginationItem key={i}>
