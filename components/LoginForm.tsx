...
export default function LoginForm() {
  ...
  const handleSignIn = async (e:any) => {
    ...
    try {
      ...
      // User signed in successfully, handle redirection or state update
      ...
      <div className="w-full md:w-1/2 flex flex-col space-y-6 md:space-y-10 px-4 md:px-12">
        ...
        <FieldGroup className="space-y-4 md:space-y-6">
          ...
          <Field
            ...
            className="space-y-2 md:space-y-0 md:flex md:flex-row md:items-center md:gap-4"
          >
            <Button type="reset" variant="outline" className="w-full md:flex-1">
              Reset
            </Button>
            <Button type="submit" className="w-full md:flex-1 bg-[#1ABA1A] text-white" onClick={handleSignIn}>
              Submit
            </Button>
          </Field>
